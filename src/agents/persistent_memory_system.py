...
class SemanticMemory:
    ...
    async def store_knowledge(self, content: Dict[str, Any], tags: List[str] = None) -> str:
        ...
        try:
            item = {
                ...
                'embeddings': base64.b64encode(json.dumps(entry.embeddings).encode()).decode(),
    ...
    async def search_knowledge(self, query: str, limit: int = 5, min_similarity: float = 0.7) -> List[MemoryEntry]:
        ...
        try:
            ...
            for item in response['Items']:
                try:
                    # Decode embeddings
                    item_embeddings = json.loads(base64.b64decode(item['embeddings']).decode())

                    # Calculate similarity
                    similarity = self.vector_store.cosine_similarity(query_embeddings, item_embeddings)
...
class EpisodicMemory:
    ...
    async def find_similar_experiences(self, context: Dict[str, Any], experience_type: ExperienceType = None, limit: int = 5) -> List[Experience]:
        ...
        try:
            ...
            for item in response['Items']:
                try:
                    ...
                    similarity = self._calculate_context_similarity(context, experience.input_context)
...
class ProceduralMemory:
    ...
    async def find_applicable_procedures(self, conditions: Dict[str, Any], min_success_rate: float = 0.7) -> List[Procedure]:
        ...
        try:
            ...
            for item in response['Items']:
                try:
                    ...
                    if (procedure.success_rate >= min_success_rate and
                        self._conditions_match(conditions, procedure.conditions)):
    ...
    def _conditions_match(self, current: Dict[str, Any], required: Dict[str, Any]) -> bool:
...
class PersistentMemorySystem:
    ...
    async def initialize_knowledge_base(self):
        ...
        foundational_knowledge = [
            {
                ...
                "typical_sections": ["overview", "authentication", "endpoints", "examples", "errors"],
            ...
            },
            {
                ...
                "typical_sections": ["prerequisites", "setup", "configuration", "testing"],
        ...
        for knowledge in foundational_knowledge:
            await self.semantic_memory.store_knowledge(
                knowledge,
                tags=knowledge.get("type", "").split("_")
            )
    ...
    async def learn_from_experience(self, experience: Experience):
        ...
        for lesson in experience.lessons_learned:
            ...
            await self.semantic_memory.store_knowledge(
                lesson_knowledge,
                tags=["lesson", experience.experience_type.value]
            )
    ...
    async def get_contextual_insights(self, current_context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        semantic_results = await self.semantic_memory.search_knowledge(context_query, limit=3)
...
async def enhance_with_persistent_memory(agent_context: Dict[str, Any], memory_system: PersistentMemorySystem) -> Dict[str, Any]:
    """
