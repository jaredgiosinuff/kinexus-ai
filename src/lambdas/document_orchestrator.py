...
class DocumentOrchestrator:
    ...
    async def process_change(self, change_id: str) -> Dict[str, Any]:
        ...
        logger.info(f"Processing change", change_id=change_id,
    ...
    async def analyze_documentation_impact(self, change_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            elif any(f.endswith('.py') or f.endswith('.js') or f.endswith('.ts') for f in files_changed):
                return {
                    'action': 'update',
    ...
    async def create_documentation(self, change_data: Dict[str, Any], analysis: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Store in S3
            document_id = f"doc_{change_data['change_id']}_{datetime.utcnow().timestamp()}"
    ...
    async def update_documentation(self, change_data: Dict[str, Any], analysis: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _build_generation_prompt(self, change_data: Dict[str, Any], analysis: Dict[str, Any], is_update: bool = False) -> str:
